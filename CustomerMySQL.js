...
app.post(apiversion + '/customer',  function (req, res) {
  ...
  db.query(`INSERT INTO customers 
    (customerName,customerAdress,customerAge,customerPicture) 
    VALUES ('${customerName}', '${customerAddress}', ${customerAge}, '${customerPicture}');`,function (error, results, fields) {
...
app.post(apiversion + '/upload', (req, res) => {
  ...
  myFile.mv({Areapicturepath},{myFilename}, function (err) {
